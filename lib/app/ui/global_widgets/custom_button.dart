...
class CsButtonOptions {
  const CsButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class CsButtonWidget extends StatefulWidget {
  const CsButtonWidget({
    super.key,
    required this.text,
  ...
  final CsButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<CsButtonWidget> createState() => _CsButtonWidgetState();
}

class _CsButtonWidgetState extends State<CsButtonWidget> {
  bool loading = false;
